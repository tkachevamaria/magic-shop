...
function renderSidebarPanel() {
        ...
        <div class="sidebar-panel" id="sidebarPanel">
            <div class="user-profile">
                ...
                <div class="user-level">
                    <button class="level-badge" id="darkModeTrigger" type="button">${userLevelName}</button>
                </div>
            </div>
      ...
      switch (page) {
        ...
        case "logout":
          if (confirm("Вы уверены, что хотите выйти?")) {
            ...
            sessionStorage.removeItem("darkModeUnlocked");
  ...
  document.querySelectorAll(".nav-item").forEach((item) => {
    if (
      ...
      item.getAttribute("data-page") === "orders"
    ) {
      item.classList.add("active");
    }
    if (
      currentPage === "purchases.html" &&
      item.getAttribute("data-page") === "purchases"
    ) {
      item.classList.add("active");
    }
  });
