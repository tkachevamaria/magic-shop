...
function renderPurchasesPage() {
    ...
    loadPurchases().then(orders => {
        ...
        // Считаем общую статистику по всем товарам всех заказов
        let totalAmount = 0;
        let totalItems = 0;
        ...
        // Выводим все товары подряд из всех заказов без группировки по доставке.
        // quantity и дедупликация уже сделаны на беке в loadItems.
        orders.forEach(order => {
